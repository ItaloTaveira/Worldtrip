...
function Coverflow3D({
  ...
  const handleCardClick = useCallback(
    (i) => {
      if (lockRef.current || autoplay) return;
      lock();
  ...
  return (
    <div
      style={rootStyle}
      className={`coverflow3d ${className || ''}`}
      tabIndex={0}
      role="group"
      ...
      >
        {list.map((slide, i) => {
          ...
          return (
            <div
              key={i}
              className={`coverflow3d-card ${isActive ? 'active' : ''}`}
              style={cardStyle}
            ...
            >
              ...
              {showTitle && (
                <>
                  <div
                    className="coverflow3d-gradient"
                    style={{
                      position: 'absolute',
                      inset: 0,
                      background: isTop
                  ...
                  <div
                    className="coverflow3d-title-wrapper"
                    style={{
                      position: 'absolute',
                      left: padLeft,
                      right: padRight,
